...
# Source File - will give you file path depending on system's OS
SRCFILE = os.path.join(cfg.DATADIR, 'qan_prc_2020.csv')
# Destination file - create a new text file
...
# object):
fobj = open(SRCFILE, mode='r') # redundant mode option as selected default value
...
# This will not work as file objects are actually iterators
...
# But after exiting the context manager (block of code), the file will automatically close
