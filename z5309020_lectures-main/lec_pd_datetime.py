...
# Given following datetime object, print x as "Sunday of week number 53 of the year 2023"
...
#What is the value of "Adj Close" for 15th trading day in march 2019 in the prc dataframe?
prc = pd.read_csv(CSVLOC, parse_dates=['Date'], index_col='Date')
print("HERE")
print(prc)
result = prc.loc['2019-03'].iloc[4]
print(result)
